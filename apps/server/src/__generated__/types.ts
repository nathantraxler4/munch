...
export type MenuStreamResolvers<
    ContextType = any,
    ParentType extends ResolversParentTypes['MenuStream'] = ResolversParentTypes['MenuStream']
> = {
...
> = {
    ...
    generateMenuFromPrompt?: Resolver<
        ...
        ParentType,
        ContextType,
        RequireFields<MutationGenerateMenuFromPromptArgs, 'prompt'>
    >;
};

export type PartialMenuResolvers<
    ContextType = any,
    ParentType extends ResolversParentTypes['PartialMenu'] = ResolversParentTypes['PartialMenu']
> = {
...
export type StreamErrorResolvers<
    ContextType = any,
    ParentType extends ResolversParentTypes['StreamError'] = ResolversParentTypes['StreamError']
> = {
...
> = {
    generateMenuFromPrompt?: SubscriptionResolver<
        Maybe<ResolversTypes['MenuStream']>,
        'generateMenuFromPrompt',
        ParentType,
        ContextType,
        RequireFields<SubscriptionGenerateMenuFromPromptArgs, 'prompt'>
    >;
};
